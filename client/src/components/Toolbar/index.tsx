...
const NotionToolbar = (props: ToolbarRenderProps) => {
  ...
  const { refs: actionMenuRefs, floatingStyles: actionMenuStyles } =
    useFloating({
  ...
  const blockLabel =
    activeBlock?.options?.display?.title || activeBlock?.type || "";
      ...
      <div className={s.toolbar}>
        ...
        <div className={s.group}>
          <button
            ...
            className={cx(s.item, {
              [s.active]: editor.formats.bold.isActive(),
            })}
          >
          ...
          <button
            ...
            className={cx(s.item, {
              [s.active]: editor.formats.italic.isActive(),
            })}
          >
          ...
          <button
            ...
            className={cx(s.item, {
              [s.active]: editor.formats.underline.isActive(),
            })}
          >
          ...
          <button
            ...
            className={cx(s.item, {
              [s.active]: editor.formats.strike.isActive(),
            })}
          >
          ...
          <button
            ...
            className={cx(s.item, {
              [s.active]: editor.formats.code.isActive(),
            })}
          >
